...
video_path       = r"C:\Users\Lenovo X1 Carbon\OneDrive\Documents\Doutsen\Bachelor project\Results Porcine\Video\Porcine_22.mp4"
start_frame_idx  = 442       # starting frame from where tracking should begin
...
while True:
    ...
    # Measured depth
    pixel_dist = abs(h_t[1] - t_t[1]) * mm_per_pixel
    measured_depths.append(max(0, needle_length_mm - pixel_dist))

    # Indentation: vertical distance
    pv = abs(s_t[1] - init_surf_y)
    indentation = max(0, pv * mm_per_pixel)
